...
/**
 * <p>Java class for dmLicensedFeature.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="dmLicensedFeature">
 ...
 * 
 */
@XmlType(name = "dmLicensedFeature")
@XmlEnum
public enum DmLicensedFeature {
    ...
    public static DmLicensedFeature fromValue(String v) {
        for (DmLicensedFeature c: DmLicensedFeature.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
