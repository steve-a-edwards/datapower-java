...
/**
 * <p>Java class for ConfigNFSStaticMount complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ConfigNFSStaticMount">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.datapower.com/schemas/management}ConfigConfigBase">
 *       &lt;choice maxOccurs="unbounded">
 *         &lt;element name="UserSummary" type="{http://www.datapower.com/schemas/management}dmString" minOccurs="0"/>
 *         &lt;element name="remote" type="{http://www.datapower.com/schemas/management}dmString"/>
 *         &lt;element name="LocalFilesystemAccess" type="{http://www.datapower.com/schemas/management}dmToggle" minOccurs="0"/>
...
@XmlType(name = "ConfigNFSStaticMount", propOrder = {
    "userSummaryOrRemoteOrLocalFilesystemAccess"
})
    ...
    extends ConfigConfigBase
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "remote", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "LocalFilesystemAccess", type = JAXBElement.class),
    ...
    protected List<JAXBElement<?>> userSummaryOrRemoteOrLocalFilesystemAccess;
    @XmlAttribute
    ...
    /**
     * Gets the value of the userSummaryOrRemoteOrLocalFilesystemAccess property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the userSummaryOrRemoteOrLocalFilesystemAccess property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUserSummaryOrRemoteOrLocalFilesystemAccess().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getUserSummaryOrRemoteOrLocalFilesystemAccess() {
        if (userSummaryOrRemoteOrLocalFilesystemAccess == null) {
            userSummaryOrRemoteOrLocalFilesystemAccess = new ArrayList<JAXBElement<?>>();
        }
        return this.userSummaryOrRemoteOrLocalFilesystemAccess;
    }
