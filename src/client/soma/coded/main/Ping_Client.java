...
// Build up request:
		...
		if (result != null)
			System.out.println("Result content: " + (result.getContent()).toArray()[0]);
	}
}
 ...
 * <ns2:do-action> <Ping> <RemoteHost>192.168.1.102</RemoteHost> </Ping>
 * </ns2:do-action> </ns2:request> </S:Body> </S:Envelope>
 * 
 * Response (if success):
 * 
 ...
 * <env:Body> <dp:response
 * xmlns:dp="http://www.datapower.com/schemas/management">
 * <dp:timestamp>2014-11-15T23:08:27-05:00</dp:timestamp> <dp:result>
 * <error-log> <log-event level="error">Host unreachable:
 * '192.168.1.202'</log-event> </error-log> </dp:result> </dp:response>
